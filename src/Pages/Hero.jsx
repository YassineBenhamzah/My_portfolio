...
export default function Hero() {
    ...
    return (
        <section
            className={`min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-20 py-12 relative overflow-hidden ${
                isDarkMode ? "text-white" : "text-gray-900"
            }`}
        >
            ...
            {/* Hero content */}
            <div
                className={`relative z-10 w-full flex flex-col-reverse md:flex-row items-center md:justify-between gap-8 md:gap-16 py-12 md:py-24 px-4 sm:px-6 md:px-12 shadow-none md:shadow-2xl rounded-none md:rounded-lg max-w-full md:max-w-6xl border-0 md:border ${
                    isDarkMode
            ...
            >
                ...
                <div className="text-center md:text-start max-w-lg">
                    ...
                    <h1
                        className={`text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 leading-snug md:leading-tight ${
                            isDarkMode ? "text-white" : "text-gray-900"
                        }`}
                    >
                        Hello I'm <br />
                ...
                <div className="relative w-48 sm:w-56 md:w-80 h-48 sm:h-56 md:h-80 mx-auto mt-8 md:mt-0 flex-shrink-0">
                    <div
                        className={`absolute inset-0 rounded-full shadow-2xl flex items-center justify-center overflow-hidden transform transition-transform duration-500 hover:scale-105 border-2 ${
                            isDarkMode
                    ...
                    <span
                        className={`absolute -top-3 -left-3 w-10 sm:w-14 md:w-20 h-10 sm:h-14 md:h-20 rounded-full opacity-30 animate-pulse ${
                            isDarkMode ? "bg-green-500" : "bg-green-600"
                        }`}
                    ></span>
                    <span
                        className={`absolute -bottom-3 -right-3 w-14 sm:w-20 md:w-24 h-14 sm:h-20 md:h-24 rounded-full opacity-20 animate-pulse ${
                            isDarkMode ? "bg-green-500" : "bg-green-600"
                        }`}
                    ></span>
                </div>
